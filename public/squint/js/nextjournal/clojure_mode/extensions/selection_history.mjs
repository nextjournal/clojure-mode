...
return squint_core.first(squint_core.filter((function (p__392) {
let map__23 = p__392;
...
return u.update_ranges(state, ({ "annotations": event_annotation }), (function (p__393) {
let map__12 = p__393;
let range3 = map__12;
...
return ({ "range": (function () {
 ...
 let G__3948 = n.nearest_touching(state, from4, -1);
let test__27847__auto__9 = squint_core.nil_QMARK_(G__3948);
if (test__27847__auto__9 != null && test__27847__auto__9 !== false) {
return null;} else {
return n.balanced_range(state, G__3948);}
})();
...
return ({ "range": (function () {
 ...
 let G__39511 = grow_1(state, from4, to5);
let test__27847__auto__12 = squint_core.nil_QMARK_(G__39511);
if (test__27847__auto__12 != null && test__27847__auto__12 !== false) {
return null;} else {
return n.range(G__39511);}
})();
