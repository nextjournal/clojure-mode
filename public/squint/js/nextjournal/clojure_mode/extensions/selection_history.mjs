...
let test__23322__auto__1 = (arr["length"] > 1);
...
let test__23322__auto__9 = sel.eq_QMARK_(squint_core.get(x, "selection"), selection6);
...
let test__23322__auto__10 = !something_selected_QMARK_(selection6);
...
return squint_core.first(squint_core.filter((function (p__455) {
let map__23 = p__455;
let a_start4 = squint_core.get(map__23, "from");
let a_end5 = squint_core.get(map__23, "to");
let and__25548__auto__6 = (a_start4 <= start);
if (and__25548__auto__6 != null && and__25548__auto__6 !== false) {
let and__25548__auto__7 = (a_end5 >= end);
if (and__25548__auto__7 != null && and__25548__auto__7 !== false) {
return !(function () {
 let and__25548__auto__8 = (a_start4 == start);
if (and__25548__auto__8 != null && and__25548__auto__8 !== false) {
return (a_end5 == end);} else {
return and__25548__auto__8;}
})();} else {
return and__25548__auto__7;}} else {
return and__25548__auto__6;}
...
return u.update_ranges(state, ({ "annotations": event_annotation }), (function (p__456) {
let map__12 = p__456;
let range3 = map__12;
...
return ({ "range": (function () {
 let or__25526__auto__7 = (function () {
 let G__4578 = n.nearest_touching(state, from4, -1);
let test__23322__auto__9 = squint_core.nil_QMARK_(G__4578);
if (test__23322__auto__9 != null && test__23322__auto__9 !== false) {
return null;} else {
return n.balanced_range(state, G__4578);}
})();
...
return ({ "range": (function () {
 ...
 let G__45811 = grow_1(state, from4, to5);
let test__23322__auto__12 = squint_core.nil_QMARK_(G__45811);
if (test__23322__auto__12 != null && test__23322__auto__12 !== false) {
return null;} else {
return n.range(G__45811);}
})();
...
let temp__24874__auto__1 = squint_core.get(squint_core.second(stack(state)), "selection");
if (temp__24874__auto__1 != null && temp__24874__auto__1 !== false) {
let selection2 = temp__24874__auto__1;
