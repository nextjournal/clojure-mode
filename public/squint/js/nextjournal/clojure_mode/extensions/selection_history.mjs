...
let test__23379__auto__1 = (arr["length"] > 1);
...
let test__23379__auto__9 = sel.eq_QMARK_(squint_core.get(x, "selection"), selection6);
...
let test__23379__auto__10 = !something_selected_QMARK_(selection6);
...
return squint_core.first(squint_core.filter((function (p__286) {
let map__23 = p__286;
let a_start4 = squint_core.get(map__23, "from");
let a_end5 = squint_core.get(map__23, "to");
let and__25515__auto__6 = (a_start4 <= start);
if (and__25515__auto__6 != null && and__25515__auto__6 !== false) {
let and__25515__auto__7 = (a_end5 >= end);
if (and__25515__auto__7 != null && and__25515__auto__7 !== false) {
return !(function () {
 let and__25515__auto__8 = (a_start4 == start);
...
return u.update_ranges(state, ({ "annotations": event_annotation }), (function (p__287) {
let map__12 = p__287;
let range3 = map__12;
...
return ({ "range": (function () {
 let or__25502__auto__7 = (function () {
 let G__2888 = n.nearest_touching(state, from4, -1);
let test__23379__auto__9 = squint_core.nil_QMARK_(G__2888);
if (test__23379__auto__9 != null && test__23379__auto__9 !== false) {
return null;} else {
return n.balanced_range(state, G__2888);}
})();
...
return ({ "range": (function () {
 ...
 let G__28911 = grow_1(state, from4, to5);
let test__23379__auto__12 = squint_core.nil_QMARK_(G__28911);
if (test__23379__auto__12 != null && test__23379__auto__12 !== false) {
return null;} else {
return n.range(G__28911);}
})();
...
let temp__24827__auto__1 = squint_core.get(squint_core.second(stack(state)), "selection");
if (temp__24827__auto__1 != null && temp__24827__auto__1 !== false) {
let selection2 = temp__24827__auto__1;
