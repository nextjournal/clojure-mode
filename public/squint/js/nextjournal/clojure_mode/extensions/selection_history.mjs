...
let test__172426__auto__1 = (arr["length"] > 1);
...
let test__172426__auto__9 = sel.eq_QMARK_(squint_core.get(x, "selection"), selection6);
...
let test__172426__auto__10 = !something_selected_QMARK_(selection6);
...
return squint_core.first(squint_core.filter((function (p__826) {
let map__23 = p__826;
...
return u.update_ranges(state, ({ "annotations": event_annotation }), (function (p__827) {
let map__12 = p__827;
let range3 = map__12;
...
return ({ "range": (function () {
 ...
 let G__8288 = n.nearest_touching(state, from4, -1);
let test__172426__auto__9 = squint_core.nil_QMARK_(G__8288);
if (test__172426__auto__9 != null && test__172426__auto__9 !== false) {
return null;} else {
return n.balanced_range(state, G__8288);}
})();
...
return ({ "range": (function () {
 ...
 let G__82911 = grow_1(state, from4, to5);
let test__172426__auto__12 = squint_core.nil_QMARK_(G__82911);
if (test__172426__auto__12 != null && test__172426__auto__12 !== false) {
return null;} else {
return n.range(G__82911);}
})();
