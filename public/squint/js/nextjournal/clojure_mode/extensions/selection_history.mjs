...
let test__78824__auto__1 = (arr["length"] > 1);
...
let test__78824__auto__9 = sel.eq_QMARK_(squint_core.get(x, "selection"), selection6);
...
let test__78824__auto__10 = !something_selected_QMARK_(selection6);
...
return squint_core.first(squint_core.filter((function (p__418) {
let map__23 = p__418;
...
return u.update_ranges(state, ({ "annotations": event_annotation }), (function (p__419) {
let map__12 = p__419;
let range3 = map__12;
...
return ({ "range": (function () {
 ...
 let G__4208 = n.nearest_touching(state, from4, -1);
let test__78824__auto__9 = squint_core.nil_QMARK_(G__4208);
if (test__78824__auto__9 != null && test__78824__auto__9 !== false) {
return null;} else {
return n.balanced_range(state, G__4208);}
})();
...
return ({ "range": (function () {
 ...
 let G__42111 = grow_1(state, from4, to5);
let test__78824__auto__12 = squint_core.nil_QMARK_(G__42111);
if (test__78824__auto__12 != null && test__78824__auto__12 !== false) {
return null;} else {
return n.range(G__42111);}
})();
