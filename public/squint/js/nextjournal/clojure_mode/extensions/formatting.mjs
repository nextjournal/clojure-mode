...
var indent_node_props = (function (p__514) {
let map__12 = p__514;
let type3 = map__12;
let type_name4 = squint_core.get(map__12, "name");
return function (p__515) {
let map__56 = p__515;
...
let G__51611 = context7.column(n.end(n.down(node8)));
...
return squint_core.contains_QMARK_(new Set(["Operator", "DefLike", "NS"]), (function () {
 let G__51714 = node8;
let G__51715 = (function () {
 let test__27847__auto__16 = squint_core.nil_QMARK_(G__51714);
if (test__27847__auto__16 != null && test__27847__auto__16 !== false) {
return null;} else {
return n.down(G__51714);}
})();
let G__51717 = (function () {
 let test__27847__auto__18 = squint_core.nil_QMARK_(G__51715);
if (test__27847__auto__18 != null && test__27847__auto__18 !== false) {
return null;} else {
return n.right(G__51715);}
})();
let test__27847__auto__19 = squint_core.nil_QMARK_(G__51717);
if (test__27847__auto__19 != null && test__27847__auto__19 !== false) {
return null;} else {
return n.name(G__51717);}
})());} else {
return and__28236__auto__13;}
})();
if (test__27847__auto__12 != null && test__27847__auto__12 !== false) {
return (G__51611 + 1);} else {
return G__51611;}} else {
...
let G__5184 = squint_core.compare(indent3, current_indent2);
switch (G__5184) {case 0:
return null;
break;
case 1:
...
break;
default:
throw new Error(squint_core.str("No matching clause: ", G__5184))}}
}));
});
...
let trim_QMARK_3 = (function () {
 let G__5194 = squint_core.first(nodes1);
let G__5195 = (function () {
 let test__27847__auto__6 = squint_core.nil_QMARK_(G__5194);
if (test__27847__auto__6 != null && test__27847__auto__6 !== false) {
return null;} else {
return n.end(G__5194);}
})();
let test__27847__auto__7 = squint_core.nil_QMARK_(G__5195);
if (test__27847__auto__7 != null && test__27847__auto__7 !== false) {
return null;} else {
return (G__5195 < to);}
})();
return squint_core.reduce((function (out, p__520) {
let vec__813 = p__520;
...
let G__52122 = squint_core.compare(actual21, expected20);
switch (G__52122) {case 0:
return out;
break;
case 1:
let G__52224 = out;
G__52224.push(({ "from": (function () {
...
case -1:
let G__52326 = out;
G__52326.push(({ "from": end119, "insert": " " }));
return G__52326;
break;
default:
return out;}
...
let indentation_change4 = ((indent3 != null && indent3 !== false) ? ((function () {
 let G__5245 = squint_core.compare(indent3, current_indent2);
switch (G__5245) {case 0:
return null;
break;
case 1:
return ({ "from": (from + current_indent2), "insert": spaces(state, (indent3 - current_indent2)) });
...
break;
default:
throw new Error(squint_core.str("No matching clause: ", G__5245))}
})()) : (null));
...
let G__52511 = changes;
let G__52512 = ((space_changes7 != null && space_changes7 !== false) ? (into_arr(G__52511, space_changes7)) : (G__52511));
if (indentation_change4 != null && indentation_change4 !== false) {
let G__52613 = G__52512;
G__52613.push(indentation_change4);
return G__52613;} else {
return G__52512;}
});
var format_selection = (function (state) {
let context1 = make_indent_context(state);
return u.update_selected_lines(state, (function (p__527, changes) {
let map__23 = p__527;
let _line4 = map__23;
