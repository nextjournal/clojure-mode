...
var indent_node_props = (function (p__780) {
let map__12 = p__780;
let type3 = map__12;
...
let test__172426__auto__9 = ("Program" === type_name4);
if (test__172426__auto__9 != null && test__172426__auto__9 !== false) {
return 0;} else {
let test__172426__auto__10 = n.coll_type_QMARK_(type3);
if (test__172426__auto__10 != null && test__172426__auto__10 !== false) {
let G__78211 = context7.column(n.end(n.down(node8)));
let test__172426__auto__12 = (function () {
...
return squint_core.contains_QMARK_(new Set(["Operator", "DefLike", "NS"]), (function () {
 let G__78314 = node8;
let G__78315 = (function () {
 let test__172426__auto__16 = squint_core.nil_QMARK_(G__78314);
if (test__172426__auto__16 != null && test__172426__auto__16 !== false) {
return null;} else {
return n.down(G__78314);}
})();
let G__78317 = (function () {
 let test__172426__auto__18 = squint_core.nil_QMARK_(G__78315);
if (test__172426__auto__18 != null && test__172426__auto__18 !== false) {
return null;} else {
return n.right(G__78315);}
})();
let test__172426__auto__19 = squint_core.nil_QMARK_(G__78317);
if (test__172426__auto__19 != null && test__172426__auto__19 !== false) {
return null;} else {
return n.name(G__78317);}
})());} else {
return and__32262__auto__13;}
})();
if (test__172426__auto__12 != null && test__172426__auto__12 !== false) {
return (G__78211 + 1);} else {
return G__78211;}} else {
let test__172426__auto__20 = "else";
...
let G__7844 = squint_core.compare(indent3, current_indent2);
switch (G__7844) {case 0:
return null;
break;
case 1:
...
break;
default:
throw new Error(squint_core.str("No matching clause: ", G__7844))}}
}));
});
...
let trim_QMARK_3 = (function () {
 let G__7854 = squint_core.first(nodes1);
let G__7855 = (function () {
 let test__172426__auto__6 = squint_core.nil_QMARK_(G__7854);
if (test__172426__auto__6 != null && test__172426__auto__6 !== false) {
return null;} else {
return n.end(G__7854);}
})();
let test__172426__auto__7 = squint_core.nil_QMARK_(G__7855);
if (test__172426__auto__7 != null && test__172426__auto__7 !== false) {
return null;} else {
return (G__7855 < to);}
})();
return squint_core.reduce((function (out, p__786) {
let vec__813 = p__786;
...
let G__78722 = squint_core.compare(actual21, expected20);
switch (G__78722) {case 0:
return out;
break;
case 1:
return u.push_BANG_(out, ({ "from": (function () {
 let test__172426__auto__24 = (expected20 == 0);
...
let indentation_change3 = ((indent2 != null && indent2 !== false) ? ((function () {
 let G__7884 = squint_core.compare(indent2, current_indent1);
switch (G__7884) {case 0:
return null;
break;
case 1:
...
break;
default:
throw new Error(squint_core.str("No matching clause: ", G__7884))}
})()) : (null));
let space_changes6 = (function () {
 let test__172426__auto__7 = (function () {
...
let G__78910 = changes;
let G__78911 = ((space_changes6 != null && space_changes6 !== false) ? (into_arr(G__78910, space_changes6)) : (G__78910));
if (indentation_change3 != null && indentation_change3 !== false) {
return u.push_BANG_(G__78911, indentation_change3);} else {
return G__78911;}
});
var format_selection = (function (state) {
let context1 = make_indent_context(state);
return u.update_selected_lines(state, (function (p__790, changes, _range) {
let map__23 = p__790;
let _line4 = map__23;
...
let temp__31764__auto__2 = (function () {
 let test__172426__auto__3 = n.within_program_QMARK_(tr["startState"]);
if (test__172426__auto__3 != null && test__172426__auto__3 !== false) {
let G__7914 = origin1;
switch (G__7914) {case "input":
return null;
break;
case "input.type":
return null;
...
break;
default:
let test__172426__auto__6 = tr["changes"]["empty"];
if (test__172426__auto__6 != null && test__172426__auto__6 !== false) {
return null;} else {
let state7 = tr["state"];
...
let test__172426__auto__9 = squint_core.nil_QMARK_(temp__31764__auto__2);
if (test__172426__auto__9 != null && test__172426__auto__9 !== false) {
return tr;} else {
...
let test__172426__auto__1 = u.something_selected_QMARK_(state);
if (test__172426__auto__1 != null && test__172426__auto__1 !== false) {
