...
var indent_node_props = (function (p__494) {
let map__12 = p__494;
let type3 = map__12;
let type_name4 = squint_core.get(map__12, "name");
return function (p__495) {
let map__56 = p__495;
...
let G__49611 = context7.column(n.end(n.down(node8)));
...
return squint_core.contains_QMARK_(new Set(["Operator", "DefLike", "NS"]), (function () {
 let G__49714 = node8;
let G__49715 = (function () {
 let test__27847__auto__16 = squint_core.nil_QMARK_(G__49714);
if (test__27847__auto__16 != null && test__27847__auto__16 !== false) {
return null;} else {
return n.down(G__49714);}
})();
let G__49717 = (function () {
 let test__27847__auto__18 = squint_core.nil_QMARK_(G__49715);
if (test__27847__auto__18 != null && test__27847__auto__18 !== false) {
return null;} else {
return n.right(G__49715);}
})();
let test__27847__auto__19 = squint_core.nil_QMARK_(G__49717);
if (test__27847__auto__19 != null && test__27847__auto__19 !== false) {
return null;} else {
return n.name(G__49717);}
})());} else {
return and__28236__auto__13;}
})();
if (test__27847__auto__12 != null && test__27847__auto__12 !== false) {
return (G__49611 + 1);} else {
return G__49611;}} else {
...
let G__4984 = squint_core.compare(indent3, current_indent2);
switch (G__4984) {case 0:
return null;
break;
case 1:
...
break;
default:
throw new Error(squint_core.str("No matching clause: ", G__4984))}}
}));
});
...
let trim_QMARK_3 = (function () {
 let G__4994 = squint_core.first(nodes1);
let G__4995 = (function () {
 let test__27847__auto__6 = squint_core.nil_QMARK_(G__4994);
if (test__27847__auto__6 != null && test__27847__auto__6 !== false) {
return null;} else {
return n.end(G__4994);}
})();
let test__27847__auto__7 = squint_core.nil_QMARK_(G__4995);
if (test__27847__auto__7 != null && test__27847__auto__7 !== false) {
return null;} else {
return (G__4995 < to);}
})();
return squint_core.reduce((function (out, p__500) {
let vec__813 = p__500;
...
let G__50122 = squint_core.compare(actual21, expected20);
switch (G__50122) {case 0:
return out;
break;
case 1:
let G__50224 = out;
G__50224.push(({ "from": (function () {
...
case -1:
let G__50326 = out;
G__50326.push(({ "from": end119, "insert": " " }));
return G__50326;
break;
default:
return out;}
...
let indentation_change3 = ((indent2 != null && indent2 !== false) ? ((function () {
 let G__5044 = squint_core.compare(indent2, current_indent1);
switch (G__5044) {case 0:
return null;
break;
case 1:
...
break;
default:
throw new Error(squint_core.str("No matching clause: ", G__5044))}
})()) : (null));
...
let G__50510 = changes;
let G__50511 = ((space_changes6 != null && space_changes6 !== false) ? (into_arr(G__50510, space_changes6)) : (G__50510));
if (indentation_change3 != null && indentation_change3 !== false) {
let G__50612 = G__50511;
G__50612.push(indentation_change3);
return G__50612;} else {
return G__50511;}
});
var format_selection = (function (state) {
let context1 = make_indent_context(state);
return u.update_selected_lines(state, (function (p__507, changes, _range) {
let map__23 = p__507;
let _line4 = map__23;
