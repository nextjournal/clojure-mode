...
let test__78824__auto__1 = (function () {
 ...
 let G__3823 = n.node_BAR_(state, (from - 1));
let test__78824__auto__4 = squint_core.nil_QMARK_(G__3823);
if (test__78824__auto__4 != null && test__78824__auto__4 !== false) {
return null;} else {
return u.guard(G__3823, n.line_comment_QMARK_);}
})();
...
var handle_backspace = (function (p__383) {
let map__12 = p__383;
let state3 = map__12;
...
if (test__78824__auto__4 != null && test__78824__auto__4 !== false) {
return null;} else {
return u.update_ranges(state3, ({ "annotations": u.user_event_annotation("delete") }), (function (p__384) {
let map__89 = p__384;
...
let test__78824__auto__26 = (function () {
...
let test__78824__auto__28 = (function () {
...
let test__78824__auto__31 = n.empty_QMARK_(n.up(node_BAR_19));
if (test__78824__auto__31 != null && test__78824__auto__31 !== false) {
return ({ "cursor": n.start(parent20), "changes": [from_to(n.start(parent20), n.end(parent20))] });} else {
return ({ "cursor": from17 });}} else {
let test__78824__auto__32 = "else";
if (test__78824__auto__32 != null && test__78824__auto__32 !== false) {
...
return u.update_ranges(state, ({ "annotations": u.user_event_annotation("input") }), (function (p__385) {
let map__23 = p__385;
...
let test__78824__auto__9 = in_string_QMARK_(state, from4);
if (test__78824__auto__9 != null && test__78824__auto__9 !== false) {
let test__78824__auto__10 = (open === "\"");
...
let test__78824__auto__11 = escaped_QMARK_(state, from4);
if (test__78824__auto__11 != null && test__78824__auto__11 !== false) {
return u.insertion(from4, to5, open);} else {
let test__78824__auto__12 = "else";
...
let or__28221__auto__10 = (function () {
 ...
 let G__38712 = n.tree(state, head5, -1);
let G__38713 = (function () {
 let test__78824__auto__14 = squint_core.nil_QMARK_(G__38712);
if (test__78824__auto__14 != null && test__78824__auto__14 !== false) {
return null;} else {
return n.ancestors(G__38712);}
})();
let G__38715 = (function () {
 let test__78824__auto__16 = squint_core.nil_QMARK_(G__38713);
if (test__78824__auto__16 != null && test__78824__auto__16 !== false) {
return null;} else {
return squint_core.filter(squint_core.every_pred(n.coll_QMARK_, squint_core.complement(n.balanced_QMARK_)), G__38713);}
})();
let test__78824__auto__17 = squint_core.nil_QMARK_(G__38715);
if (test__78824__auto__17 != null && test__78824__auto__17 !== false) {
return null;} else {
return squint_core.first(G__38715);}
})();
let closing18 = (function () {
 let G__38819 = unbalanced11;
let G__38820 = (function () {
 let test__78824__auto__21 = squint_core.nil_QMARK_(G__38819);
if (test__78824__auto__21 != null && test__78824__auto__21 !== false) {
return null;} else {
return n.down(G__38819);}
})();
let test__78824__auto__22 = squint_core.nil_QMARK_(G__38820);
if (test__78824__auto__22 != null && test__78824__auto__22 !== false) {
return null;} else {
return n.closed_by(G__38820);}
})();
let pos23 = (function () {
 let G__38924 = unbalanced11;
let test__78824__auto__25 = squint_core.nil_QMARK_(G__38924);
if (test__78824__auto__25 != null && test__78824__auto__25 !== false) {
return null;} else {
return n.end(G__38924);}
})();
let test__78824__auto__26 = (function () {
...
while(true){
let test__78824__auto__32 = n.right_edge_type_QMARK_(cursor31["type"]);
if (test__78824__auto__32 != null && test__78824__auto__32 !== false) {
return n.end(cursor31);} else {
let test__78824__auto__33 = cursor31.next();
if (test__78824__auto__33 != null && test__78824__auto__33 !== false) {
continue;
}};break;
}
}
...
var handle_backspace_cmd = (function (p__390) {
let map__12 = p__390;
let view3 = map__12;
...
return Prec.high(view.keymap.of([({ "key": "Backspace", "run": guard_scope((function (p__394) {
let map__12 = p__394;
let view3 = map__12;
let state4 = squint_core.get(map__12, "state");
return u.dispatch_some(view3, handle_backspace(state4));
