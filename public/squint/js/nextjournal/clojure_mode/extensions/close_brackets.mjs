...
let test__243599__auto__1 = (function () {
 ...
 let G__2923 = n.node_BAR_(state, (from - 1));
let test__243599__auto__4 = squint_core.nil_QMARK_(G__2923);
if (test__243599__auto__4 != null && test__243599__auto__4 !== false) {
return null;} else {
return u.guard(G__2923, n.line_comment_QMARK_);}
})();
...
var handle_backspace = (function (p__293) {
let map__12 = p__293;
let state3 = map__12;
...
if (test__243599__auto__4 != null && test__243599__auto__4 !== false) {
return null;} else {
return u.update_ranges(state3, ({ "annotations": u.user_event_annotation("delete") }), (function (p__294) {
let map__89 = p__294;
...
let test__243599__auto__21 = (function () {
...
let test__243599__auto__26 = (function () {
...
let test__243599__auto__28 = (function () {
...
let test__243599__auto__31 = n.empty_QMARK_(n.up(node_BAR_19));
if (test__243599__auto__31 != null && test__243599__auto__31 !== false) {
return ({ "cursor": n.start(parent20), "changes": [from_to(n.start(parent20), n.end(parent20))] });} else {
return ({ "cursor": from17 });}} else {
let test__243599__auto__32 = "else";
if (test__243599__auto__32 != null && test__243599__auto__32 !== false) {
...
return u.update_ranges(state, ({ "annotations": u.user_event_annotation("input") }), (function (p__295) {
let map__23 = p__295;
...
let test__243599__auto__9 = in_string_QMARK_(state, from4);
if (test__243599__auto__9 != null && test__243599__auto__9 !== false) {
let test__243599__auto__10 = (open === "\"");
...
let test__243599__auto__11 = escaped_QMARK_(state, from4);
if (test__243599__auto__11 != null && test__243599__auto__11 !== false) {
return u.insertion(from4, to5, open);} else {
let test__243599__auto__12 = "else";
...
return u.update_ranges(state, ({ "annotations": u.user_event_annotation("input") }), (function (p__296) {
let map__12 = p__296;
let _range3 = map__12;
...
let test__243599__auto__8 = (function () {
...
let or__32177__auto__10 = (function () {
 ...
 let G__29712 = n.tree(state, head5, -1);
let G__29713 = (function () {
 let test__243599__auto__14 = squint_core.nil_QMARK_(G__29712);
if (test__243599__auto__14 != null && test__243599__auto__14 !== false) {
return null;} else {
return n.ancestors(G__29712);}
})();
let G__29715 = (function () {
 let test__243599__auto__16 = squint_core.nil_QMARK_(G__29713);
if (test__243599__auto__16 != null && test__243599__auto__16 !== false) {
return null;} else {
return squint_core.filter(squint_core.every_pred(n.coll_QMARK_, squint_core.complement(n.balanced_QMARK_)), G__29713);}
})();
let test__243599__auto__17 = squint_core.nil_QMARK_(G__29715);
if (test__243599__auto__17 != null && test__243599__auto__17 !== false) {
return null;} else {
return squint_core.first(G__29715);}
})();
let closing18 = (function () {
 let G__29819 = unbalanced11;
let G__29820 = (function () {
 let test__243599__auto__21 = squint_core.nil_QMARK_(G__29819);
if (test__243599__auto__21 != null && test__243599__auto__21 !== false) {
return null;} else {
return n.down(G__29819);}
})();
let test__243599__auto__22 = squint_core.nil_QMARK_(G__29820);
if (test__243599__auto__22 != null && test__243599__auto__22 !== false) {
return null;} else {
return n.closed_by(G__29820);}
})();
let pos23 = (function () {
 let G__29924 = unbalanced11;
let test__243599__auto__25 = squint_core.nil_QMARK_(G__29924);
if (test__243599__auto__25 != null && test__243599__auto__25 !== false) {
return null;} else {
return n.end(G__29924);}
})();
let test__243599__auto__26 = (function () {
...
while(true){
let test__243599__auto__32 = n.right_edge_type_QMARK_(cursor31["type"]);
if (test__243599__auto__32 != null && test__243599__auto__32 !== false) {
return n.end(cursor31);} else {
let test__243599__auto__33 = cursor31.next();
if (test__243599__auto__33 != null && test__243599__auto__33 !== false) {
continue;
}};break;
}
}
...
var handle_backspace_cmd = (function (p__300) {
let map__12 = p__300;
let view3 = map__12;
...
return Prec.high(view.keymap.of([({ "key": "Backspace", "run": guard_scope((function (p__304) {
let map__12 = p__304;
let view3 = map__12;
let state4 = squint_core.get(map__12, "state");
return u.dispatch_some(view3, handle_backspace(state4));
