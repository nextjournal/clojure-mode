...
let test__23322__auto__1 = (function () {
 let and__25548__auto__2 = (function () {
 let G__4243 = n.node_BAR_(state, (from - 1));
let test__23322__auto__4 = squint_core.nil_QMARK_(G__4243);
if (test__23322__auto__4 != null && test__23322__auto__4 !== false) {
return null;} else {
return u.guard(G__4243, n.line_comment_QMARK_);}
})();
...
var handle_backspace = (function (p__425) {
let map__12 = p__425;
let state3 = map__12;
let test__23322__auto__4 = (function () {
 let and__25548__auto__5 = (1 === state3["selection"]["ranges"]["length"]);
if (and__25548__auto__5 != null && and__25548__auto__5 !== false) {
let range6 = squint_core.get_in(state3, ["selection", "ranges", 0]);
let and__25548__auto__7 = range6["empty"];
if (and__25548__auto__7 != null && and__25548__auto__7 !== false) {
return (0 === range6["from"]);} else {
return and__25548__auto__7;}} else {
return and__25548__auto__5;}
})();
if (test__23322__auto__4 != null && test__23322__auto__4 !== false) {
return null;} else {
return u.update_ranges(state3, ({ "annotations": u.user_event_annotation("delete") }), (function (p__426) {
let map__89 = p__426;
...
let test__23322__auto__21 = (function () {
 let or__25526__auto__22 = !empty12;
if (or__25526__auto__22 != null && or__25526__auto__22 !== false) {
return or__25526__auto__22;} else {
let or__25526__auto__23 = ("StringContent" === n.name(n.tree(state3, from17, -1)));
if (or__25526__auto__23 != null && or__25526__auto__23 !== false) {
return or__25526__auto__23;} else {
let and__25548__auto__24 = parent20;
if (and__25548__auto__24 != null && and__25548__auto__24 !== false) {
let and__25548__auto__25 = !n.balanced_QMARK_(parent20);
if (and__25548__auto__25 != null && and__25548__auto__25 !== false) {
return n.left_edge_QMARK_(node_BAR_19);} else {
return and__25548__auto__25;}} else {
return and__25548__auto__24;}}}
})();
if (test__23322__auto__21 != null && test__23322__auto__21 !== false) {
return u.deletion(from17, to18);} else {
let test__23322__auto__26 = (function () {
 let and__25548__auto__27 = n.right_edge_QMARK_(node_BAR_19);
if (and__25548__auto__27 != null && and__25548__auto__27 !== false) {
return (from17 == n.end(parent20));} else {
return and__25548__auto__27;}
})();
if (test__23322__auto__26 != null && test__23322__auto__26 !== false) {
return ({ "cursor": (from17 - 1) });} else {
let test__23322__auto__28 = (function () {
 let and__25548__auto__29 = (function () {
 let or__25526__auto__30 = n.start_edge_QMARK_(node_BAR_19);
if (or__25526__auto__30 != null && or__25526__auto__30 !== false) {
return or__25526__auto__30;} else {
return n.same_edge_QMARK_(node_BAR_19);}
})();
if (and__25548__auto__29 != null && and__25548__auto__29 !== false) {
return (n.start(node_BAR_19) == n.start(parent20));} else {
return and__25548__auto__29;}
})();
if (test__23322__auto__28 != null && test__23322__auto__28 !== false) {
let test__23322__auto__31 = n.empty_QMARK_(n.up(node_BAR_19));
if (test__23322__auto__31 != null && test__23322__auto__31 !== false) {
return ({ "cursor": n.start(parent20), "changes": [from_to(n.start(parent20), n.end(parent20))] });} else {
return ({ "cursor": from17 });}} else {
let test__23322__auto__32 = "else";
if (test__23322__auto__32 != null && test__23322__auto__32 !== false) {
...
return u.update_ranges(state, ({ "annotations": u.user_event_annotation("input") }), (function (p__427) {
let map__23 = p__427;
...
let test__23322__auto__9 = in_string_QMARK_(state, from4);
if (test__23322__auto__9 != null && test__23322__auto__9 !== false) {
let test__23322__auto__10 = (open === "\"");
...
let test__23322__auto__11 = escaped_QMARK_(state, from4);
if (test__23322__auto__11 != null && test__23322__auto__11 !== false) {
return u.insertion(from4, to5, open);} else {
let test__23322__auto__12 = "else";
...
return u.update_ranges(state, ({ "annotations": u.user_event_annotation("input") }), (function (p__428) {
let map__12 = p__428;
let _range3 = map__12;
...
let test__23322__auto__8 = (function () {
 let or__25526__auto__9 = in_string_QMARK_(state, from6);
...
let or__25526__auto__10 = (function () {
 let unbalanced11 = (function () {
 let G__42912 = n.tree(state, head5, -1);
let G__42913 = (function () {
 let test__23322__auto__14 = squint_core.nil_QMARK_(G__42912);
if (test__23322__auto__14 != null && test__23322__auto__14 !== false) {
return null;} else {
return n.ancestors(G__42912);}
})();
let G__42915 = (function () {
 let test__23322__auto__16 = squint_core.nil_QMARK_(G__42913);
if (test__23322__auto__16 != null && test__23322__auto__16 !== false) {
return null;} else {
return squint_core.filter(squint_core.every_pred(n.coll_QMARK_, squint_core.complement(n.balanced_QMARK_)), G__42913);}
})();
let test__23322__auto__17 = squint_core.nil_QMARK_(G__42915);
if (test__23322__auto__17 != null && test__23322__auto__17 !== false) {
return null;} else {
return squint_core.first(G__42915);}
})();
let closing18 = (function () {
 let G__43019 = unbalanced11;
let G__43020 = (function () {
 let test__23322__auto__21 = squint_core.nil_QMARK_(G__43019);
if (test__23322__auto__21 != null && test__23322__auto__21 !== false) {
return null;} else {
return n.down(G__43019);}
})();
let test__23322__auto__22 = squint_core.nil_QMARK_(G__43020);
if (test__23322__auto__22 != null && test__23322__auto__22 !== false) {
return null;} else {
return n.closed_by(G__43020);}
})();
let pos23 = (function () {
 let G__43124 = unbalanced11;
let test__23322__auto__25 = squint_core.nil_QMARK_(G__43124);
if (test__23322__auto__25 != null && test__23322__auto__25 !== false) {
return null;} else {
return n.end(G__43124);}
})();
let test__23322__auto__26 = (function () {
 let and__25548__auto__27 = closing18;
if (and__25548__auto__27 != null && and__25548__auto__27 !== false) {
...
let or__25526__auto__28 = (function () {
 let temp__24945__auto__29 = (function () {
 let temp__24945__auto__30 = n.terminal_cursor(n.tree(state), head5, 1);
if (temp__24945__auto__30 != null && temp__24945__auto__30 !== false) {
let cursor31 = temp__24945__auto__30;
while(true){
let test__23322__auto__32 = n.right_edge_type_QMARK_(cursor31["type"]);
if (test__23322__auto__32 != null && test__23322__auto__32 !== false) {
return n.end(cursor31);} else {
let test__23322__auto__33 = cursor31.next();
if (test__23322__auto__33 != null && test__23322__auto__33 !== false) {
continue;
}};break;
}
}
})();
if (temp__24945__auto__29 != null && temp__24945__auto__29 !== false) {
let close_node_end34 = temp__24945__auto__29;
...
var handle_backspace_cmd = (function (p__432) {
let map__12 = p__432;
let view3 = map__12;
...
return function (p__435) {
let map__12 = p__435;
let view3 = map__12;
let state4 = squint_core.get(map__12, "state");
let test__23322__auto__5 = (function () {
 let or__25526__auto__6 = n.embedded_QMARK_(state4);
...
return Prec.high(view.keymap.of([({ "key": "Backspace", "run": guard_scope((function (p__436) {
let map__12 = p__436;
let view3 = map__12;
let state4 = squint_core.get(map__12, "state");
return u.dispatch_some(view3, handle_backspace(state4));
