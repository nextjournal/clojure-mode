...
let test__27847__auto__1 = (function () {
 ...
 let G__3923 = n.node_BAR_(state, (from - 1));
let test__27847__auto__4 = squint_core.nil_QMARK_(G__3923);
if (test__27847__auto__4 != null && test__27847__auto__4 !== false) {
return null;} else {
return u.guard(G__3923, n.line_comment_QMARK_);}
})();
...
var handle_backspace = (function (p__393) {
let map__12 = p__393;
let state3 = map__12;
...
if (test__27847__auto__4 != null && test__27847__auto__4 !== false) {
return null;} else {
return u.update_ranges(state3, ({ "annotations": u.user_event_annotation("delete") }), (function (p__394) {
let map__89 = p__394;
...
return u.update_ranges(state, ({ "annotations": u.user_event_annotation("input") }), (function (p__395) {
let map__23 = p__395;
...
return u.update_ranges(state, ({ "annotations": u.user_event_annotation("input") }), (function (p__396) {
let map__12 = p__396;
let _range3 = map__12;
...
let or__28221__auto__10 = (function () {
 ...
 let G__39712 = n.tree(state, head5, -1);
let G__39713 = (function () {
 let test__27847__auto__14 = squint_core.nil_QMARK_(G__39712);
if (test__27847__auto__14 != null && test__27847__auto__14 !== false) {
return null;} else {
return n.ancestors(G__39712);}
})();
let G__39715 = (function () {
 let test__27847__auto__16 = squint_core.nil_QMARK_(G__39713);
if (test__27847__auto__16 != null && test__27847__auto__16 !== false) {
return null;} else {
return squint_core.filter(squint_core.every_pred(n.coll_QMARK_, squint_core.complement(n.balanced_QMARK_)), G__39713);}
})();
let test__27847__auto__17 = squint_core.nil_QMARK_(G__39715);
if (test__27847__auto__17 != null && test__27847__auto__17 !== false) {
return null;} else {
return squint_core.first(G__39715);}
})();
let closing18 = (function () {
 let G__39819 = unbalanced11;
let G__39820 = (function () {
 let test__27847__auto__21 = squint_core.nil_QMARK_(G__39819);
if (test__27847__auto__21 != null && test__27847__auto__21 !== false) {
return null;} else {
return n.down(G__39819);}
})();
let test__27847__auto__22 = squint_core.nil_QMARK_(G__39820);
if (test__27847__auto__22 != null && test__27847__auto__22 !== false) {
return null;} else {
return n.closed_by(G__39820);}
})();
let pos23 = (function () {
 let G__39924 = unbalanced11;
let test__27847__auto__25 = squint_core.nil_QMARK_(G__39924);
if (test__27847__auto__25 != null && test__27847__auto__25 !== false) {
return null;} else {
return n.end(G__39924);}
})();
let test__27847__auto__26 = (function () {
...
var handle_backspace_cmd = (function (p__400) {
let map__12 = p__400;
let view3 = map__12;
...
return Prec.high(view.keymap.of([({ "key": "Backspace", "run": guard_scope((function (p__404) {
let map__12 = p__404;
let view3 = map__12;
let state4 = squint_core.get(map__12, "state");
return u.dispatch_some(view3, handle_backspace(state4));
