...
var insertion = (function () {
 let f355 = (function (var_args) {
let G__3581 = arguments["length"];
switch (G__3581) {case 2:
return f355.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
case 3:
return f355.cljs$core$IFn$_invoke$arity$3((arguments[0]), (arguments[1]), (arguments[2]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f355["cljs$core$IFn$_invoke$arity$2"] = (function (from, s) {
return insertion(from, from, s);
});
f355["cljs$core$IFn$_invoke$arity$3"] = (function (from, to, s) {
return ({ "changes": ({ "insert": s, "from": from, "to": to }), "cursor": (from + squint_core.count(s)) });
});
f355["cljs$lang$maxFixedArity"] = 3;
return f355;
})();
var deletion = (function () {
 let f359 = (function (var_args) {
let G__3621 = arguments["length"];
switch (G__3621) {case 1:
return f359.cljs$core$IFn$_invoke$arity$1((arguments[0]));
break;
case 2:
return f359.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f359["cljs$core$IFn$_invoke$arity$1"] = (function (from) {
return deletion(squint_core.max(0, (from - 1)), from);
});
f359["cljs$core$IFn$_invoke$arity$2"] = (function (from, to) {
let from3 = (function () {
 let test__78824__auto__4 = (from === to);
...
f359["cljs$lang$maxFixedArity"] = 2;
return f359;
})();
...
let test__78824__auto__1 = squint_core.map_QMARK_(update_map);
if (test__78824__auto__1 != null && test__78824__auto__1 !== false) {
null} else {
...
G__36310["changes"] = change_desc9;
return G__36310;} else {
return G__36310;}
});
var update_ranges = (function () {
 let f364 = (function (var_args) {
let G__3671 = arguments["length"];
switch (G__3671) {case 2:
return f364.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
case 3:
return f364.cljs$core$IFn$_invoke$arity$3((arguments[0]), (arguments[1]), (arguments[2]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f364["cljs$core$IFn$_invoke$arity$2"] = (function (state, f) {
return update_ranges(state, null, f);
});
f364["cljs$core$IFn$_invoke$arity$3"] = (function (state, tr_specs, f) {
...
let test__78824__auto__5 = squint_core.nil_QMARK_(temp__27820__auto__4);
...
f364["cljs$lang$maxFixedArity"] = 3;
return f364;
})();
var dispatch_changes = (function (state, dispatch, changes) {
let test__78824__auto__1 = changes["empty"];
if (test__78824__auto__1 != null && test__78824__auto__1 !== false) {
return null;} else {
return dispatch(state.update(({ "changes": changes })));}
});
var update_lines = (function () {
 let f368 = (function (var_args) {
let args3691 = [];
let len__27398__auto__2 = arguments["length"];
let i3703 = 0;
while(true){
let test__78824__auto__4 = (i3703 < len__27398__auto__2);
if (test__78824__auto__4 != null && test__78824__auto__4 !== false) {
args3691.push((arguments[i3703]));
let G__5 = (i3703 + 1);
i3703 = G__5;
continue;
};break;
...
let argseq__27826__auto__6 = (function () {
 let test__78824__auto__7 = (2 < args3691["length"]);
if (test__78824__auto__7 != null && test__78824__auto__7 !== false) {
return args3691.slice(2);}
})();
return f368.cljs$core$IFn$_invoke$arity$variadic((arguments[0]), (arguments[1]), argseq__27826__auto__6);
});
f368["cljs$core$IFn$_invoke$arity$variadic"] = (function (state, f, p__374) {
let vec__812 = p__374;
...
let G__37534 = changes19;
G__37534.push(change33);
return G__37534;} else {
return changes19;}
})();
let G__35 = (from_pos20 + squint_core.count(value26));
let G__36 = (function () {
 let G__37637 = line_num21;
if (lineBreak25 != null && lineBreak25 !== false) {
return (G__37637 + 1);} else {
return G__37637;}
})();
result18 = G__29;
changes19 = G__30;
...
f368["cljs$lang$maxFixedArity"] = 2;
f368["cljs$lang$applyTo"] = (function (seq371) {
let G__37238 = squint_core.first(seq371);
let seq37139 = squint_core.next(seq371);
let G__37340 = squint_core.first(seq37139);
let seq37141 = squint_core.next(seq37139);
let self__27415__auto__42 = this;
return self__27415__auto__42.cljs$core$IFn$_invoke$arity$variadic(G__37238, G__37340, seq37141);
});
return f368;
})();
...
let doc2 = state["doc"];
return state.changeByRange((function (p__377) {
let map__34 = p__377;
let range5 = map__34;
...
let test__78824__auto__16 = (line11["number"] > squint_core.deref(at_line1));
...
var iter_changed_lines = (function (p__378, f) {
let map__13 = p__378;
let tr4 = map__13;
...
let line19 = line16;
while(true){
let test__78824__auto__20 = (line_number17 > squint_core.deref(at_line11));
...
if (test__78824__auto__23 != null && test__78824__auto__23 !== false) {
...
let test__78824__auto__27 = squint_core.seq(next_changes12);
if (test__78824__auto__27 != null && test__78824__auto__27 !== false) {
let G__37928 = squint_core.assoc_BANG_(squint_core.select_keys(tr4, ["annotations", "scrollIntoView", "reconfigure"]), "changes", changes8.compose(next_changeset26));
let G__37929 = ((selection10 != null && selection10 !== false) ? (squint_core.assoc_BANG_(G__37928, "selection", state6["selection"].map(next_changeset26))) : (G__37928));
if (effects9 != null && effects9 !== false) {
return squint_core.assoc_BANG_(G__37929, "effects", StateEffect.mapEffects(effects9, next_changeset26));} else {
return G__37929;}} else {
return tr4;}
});
var something_selected_QMARK_ = (function (p__380) {
let map__13 = p__380;
...
var range_str = (function (state, p__381) {
let map__12 = p__381;
