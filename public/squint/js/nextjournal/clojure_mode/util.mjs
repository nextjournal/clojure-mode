...
let G__6231 = arguments["length"];
switch (G__6231) {case 2:
return f620.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
case 3:
return f620.cljs$core$IFn$_invoke$arity$3((arguments[0]), (arguments[1]), (arguments[2]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f620["cljs$core$IFn$_invoke$arity$2"] = (function (from, s) {
return insertion(from, from, s);
});
f620["cljs$core$IFn$_invoke$arity$3"] = (function (from, to, s) {
return ({ "changes": ({ "insert": s, "from": from, "to": to }), "cursor": (from + squint_core.count(s)) });
});
f620["cljs$lang$maxFixedArity"] = 3;
return f620;
})();
var deletion = (function () {
 let f624 = (function (var_args) {
let G__6271 = arguments["length"];
switch (G__6271) {case 1:
return f624.cljs$core$IFn$_invoke$arity$1((arguments[0]));
break;
case 2:
return f624.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f624["cljs$core$IFn$_invoke$arity$1"] = (function (from) {
return deletion(squint_core.max(0, (from - 1)), from);
});
f624["cljs$core$IFn$_invoke$arity$2"] = (function (from, to) {
let from3 = (function () {
 let test__172426__auto__4 = (from === to);
...
f624["cljs$lang$maxFixedArity"] = 2;
return f624;
})();
...
if (or__32177__auto__11 != null && or__32177__auto__11 !== false) {
return or__32177__auto__11;} else {
return original_range;}}
})() });
if (change_desc8 != null && change_desc8 !== false) {
let G__62913 = G__6289;
squint_core.aset(G__62913, "changes", change_desc8);
return G__62913;} else {
return G__6289;}
});
var update_ranges = (function () {
 let f630 = (function (var_args) {
let G__6331 = arguments["length"];
switch (G__6331) {case 2:
return f630.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
case 3:
return f630.cljs$core$IFn$_invoke$arity$3((arguments[0]), (arguments[1]), (arguments[2]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f630["cljs$core$IFn$_invoke$arity$2"] = (function (state, f) {
return update_ranges(state, null, f);
});
f630["cljs$core$IFn$_invoke$arity$3"] = (function (state, tr_specs, f) {
return state.update((function (_PERCENT_1) {
return Object.assign(_PERCENT_1, tr_specs);
})(state.changeByRange((function (range) {
let or__32177__auto__3 = (function () {
 let temp__31896__auto__4 = f(range);
let test__172426__auto__5 = squint_core.nil_QMARK_(temp__31896__auto__4);
if (test__172426__auto__5 != null && test__172426__auto__5 !== false) {
return null;} else {
let result6 = temp__31896__auto__4;
...
f630["cljs$lang$maxFixedArity"] = 3;
return f630;
})();
var dispatch_changes = (function (state, dispatch, changes) {
let test__172426__auto__1 = changes["empty"];
if (test__172426__auto__1 != null && test__172426__auto__1 !== false) {
return null;} else {
return dispatch(state.update(({ "changes": changes })));}
});
var update_lines = (function () {
 let f634 = (function (var_args) {
let args6351 = [];
let len__31345__auto__2 = arguments["length"];
let i6363 = 0;
while(true){
let test__172426__auto__4 = (i6363 < len__31345__auto__2);
if (test__172426__auto__4 != null && test__172426__auto__4 !== false) {
args6351.push((arguments[i6363]));
let G__5 = (i6363 + 1);
i6363 = G__5;
continue;
};break;
...
;
let argseq__31776__auto__6 = (function () {
 let test__172426__auto__7 = (2 < args6351["length"]);
if (test__172426__auto__7 != null && test__172426__auto__7 !== false) {
return args6351.slice(2);}
})();
return f634.cljs$core$IFn$_invoke$arity$variadic((arguments[0]), (arguments[1]), argseq__31776__auto__6);
});
f634["cljs$core$IFn$_invoke$arity$variadic"] = (function (state, f, p__640) {
let vec__812 = p__640;
...
let test__172426__auto__27 = (function () {
 let or__32177__auto__28 = done24;
if (or__32177__auto__28 != null && or__32177__auto__28 !== false) {
return or__32177__auto__28;} else {
return (from14 > to15);}
})();
if (test__172426__auto__27 != null && test__172426__auto__27 !== false) {
return state.update(Object.assign(({ "changes": state.changes(changes19) }), spec16));} else {
let G__29 = iterator17.next();
let G__30 = (function () {
 let temp__31736__auto__31 = (function () {
 let and__32262__auto__32 = !lineBreak25;
...
if (temp__31736__auto__31 != null && temp__31736__auto__31 !== false) {
let change33 = temp__31736__auto__31;
let G__64134 = changes19;
G__64134.push(change33);
return G__64134;} else {
return changes19;}
})();
let G__35 = (from_pos20 + squint_core.count(value26));
let G__36 = (function () {
 let G__64237 = line_num21;
if (lineBreak25 != null && lineBreak25 !== false) {
return (G__64237 + 1);} else {
return G__64237;}
})();
result18 = G__29;
changes19 = G__30;
...
f634["cljs$lang$maxFixedArity"] = 2;
f634["cljs$lang$applyTo"] = (function (seq637) {
let G__63838 = squint_core.first(seq637);
let seq63739 = squint_core.next(seq637);
let G__63940 = squint_core.first(seq63739);
let seq63741 = squint_core.next(seq63739);
let self__31430__auto__42 = this;
return self__31430__auto__42.cljs$core$IFn$_invoke$arity$variadic(G__63838, G__63940, seq63741);
});
return f634;
})();
...
let doc2 = state["doc"];
return state.changeByRange((function (p__643) {
let map__34 = p__643;
let range5 = map__34;
...
let test__172426__auto__16 = (line11["number"] > squint_core.deref(at_line1));
...
let temp__31736__auto__17 = (function () {
 let and__32262__auto__18 = (to7 > line_to15);
if (and__32262__auto__18 != null && and__32262__auto__18 !== false) {
return guard(doc2.lineAt((line_to15 + 1)), (function (_PERCENT_1) {
return (_PERCENT_1["number"] > line_number14);
}));} else {
return and__32262__auto__18;}
})();
if (temp__31736__auto__17 != null && temp__31736__auto__17 !== false) {
let next_line19 = temp__31736__auto__17;
...
var iter_changed_lines = (function (p__644, f) {
let map__13 = p__644;
let tr4 = map__13;
...
let line19 = line16;
while(true){
let test__172426__auto__20 = (line_number17 > squint_core.deref(at_line11));
if (test__172426__auto__20 != null && test__172426__auto__20 !== false) {
squint_core.reset_BANG_(at_line11, line_number17);
f(line19, next_changes12)};
let test__172426__auto__21 = (to_b <= line_to18);
if (test__172426__auto__21 != null && test__172426__auto__21 !== false) {
return null;} else {
let next_line22 = doc7.lineAt((line_to18 + 1));
let test__172426__auto__23 = (function () {
 let and__32262__auto__24 = next_line22;
...
if (test__172426__auto__23 != null && test__172426__auto__23 !== false) {
...
let test__172426__auto__27 = squint_core.seq(next_changes12);
if (test__172426__auto__27 != null && test__172426__auto__27 !== false) {
let G__64528 = squint_core.assoc_BANG_(squint_core.select_keys(tr4, ["annotations", "scrollIntoView", "reconfigure"]), "changes", changes8.compose(next_changeset26));
let G__64529 = ((selection10 != null && selection10 !== false) ? (squint_core.assoc_BANG_(G__64528, "selection", state6["selection"].map(next_changeset26))) : (G__64528));
if (effects9 != null && effects9 !== false) {
return squint_core.assoc_BANG_(G__64529, "effects", StateEffect.mapEffects(effects9, next_changeset26));} else {
return G__64529;}} else {
return tr4;}
});
var something_selected_QMARK_ = (function (p__646) {
let map__13 = p__646;
...
var range_str = (function (state, p__647) {
let map__12 = p__647;
