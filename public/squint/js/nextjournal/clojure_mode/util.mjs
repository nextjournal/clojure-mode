...
var insertion = (function () {
 let f397 = (function (var_args) {
let G__4001 = arguments["length"];
switch (G__4001) {case 2:
return f397.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
case 3:
return f397.cljs$core$IFn$_invoke$arity$3((arguments[0]), (arguments[1]), (arguments[2]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f397["cljs$core$IFn$_invoke$arity$2"] = (function (from, s) {
return insertion(from, from, s);
});
f397["cljs$core$IFn$_invoke$arity$3"] = (function (from, to, s) {
return ({ "changes": ({ "insert": s, "from": from, "to": to }), "cursor": (from + squint_core.count(s)) });
});
f397["cljs$lang$maxFixedArity"] = 3;
return f397;
})();
var deletion = (function () {
 let f401 = (function (var_args) {
let G__4041 = arguments["length"];
switch (G__4041) {case 1:
return f401.cljs$core$IFn$_invoke$arity$1((arguments[0]));
break;
case 2:
return f401.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f401["cljs$core$IFn$_invoke$arity$1"] = (function (from) {
return deletion(squint_core.max(0, (from - 1)), from);
});
f401["cljs$core$IFn$_invoke$arity$2"] = (function (from, to) {
let from3 = (function () {
 let test__23322__auto__4 = (from === to);
...
f401["cljs$lang$maxFixedArity"] = 2;
return f401;
})();
...
let test__23322__auto__1 = squint_core.map_QMARK_(update_map);
if (test__23322__auto__1 != null && test__23322__auto__1 !== false) {
null} else {
...
let G__40510 = ({ "range": (function () {
 let or__25526__auto__11 = range7;
if (or__25526__auto__11 != null && or__25526__auto__11 !== false) {
return or__25526__auto__11;} else {
let or__25526__auto__12 = ((mapped4 != null && mapped4 !== false) ? (sel.cursor(change_desc9.mapPos(mapped4))) : (((cursor5 != null && cursor5 !== false) ? (sel.cursor(cursor5)) : (((from_to6 != null && from_to6 !== false) ? (sel.range(from_to6(0), from_to6(1))) : (null))))));
if (or__25526__auto__12 != null && or__25526__auto__12 !== false) {
return or__25526__auto__12;} else {
return original_range;}}
})() });
if (change_desc9 != null && change_desc9 !== false) {
G__40510["changes"] = change_desc9;
return G__40510;} else {
return G__40510;}
});
var update_ranges = (function () {
 let f406 = (function (var_args) {
let G__4091 = arguments["length"];
switch (G__4091) {case 2:
return f406.cljs$core$IFn$_invoke$arity$2((arguments[0]), (arguments[1]));
break;
case 3:
return f406.cljs$core$IFn$_invoke$arity$3((arguments[0]), (arguments[1]), (arguments[2]));
break;
default:
throw new Error(squint_core.str("Invalid arity: ", squint_core.alength(arguments)))}
});
f406["cljs$core$IFn$_invoke$arity$2"] = (function (state, f) {
return update_ranges(state, null, f);
});
f406["cljs$core$IFn$_invoke$arity$3"] = (function (state, tr_specs, f) {
return state.update((function (_PERCENT_1) {
return Object.assign(_PERCENT_1, tr_specs);
})(state.changeByRange((function (range) {
let or__25526__auto__3 = (function () {
 let temp__24981__auto__4 = f(range);
let test__23322__auto__5 = squint_core.nil_QMARK_(temp__24981__auto__4);
if (test__23322__auto__5 != null && test__23322__auto__5 !== false) {
return null;} else {
let result6 = temp__24981__auto__4;
...
f406["cljs$lang$maxFixedArity"] = 3;
return f406;
})();
var dispatch_changes = (function (state, dispatch, changes) {
let test__23322__auto__1 = changes["empty"];
if (test__23322__auto__1 != null && test__23322__auto__1 !== false) {
return null;} else {
return dispatch(state.update(({ "changes": changes })));}
});
var update_lines = (function () {
 let f410 = (function (var_args) {
let args4111 = [];
let len__24575__auto__2 = arguments["length"];
let i4123 = 0;
while(true){
let test__23322__auto__4 = (i4123 < len__24575__auto__2);
if (test__23322__auto__4 != null && test__23322__auto__4 !== false) {
args4111.push((arguments[i4123]));
let G__5 = (i4123 + 1);
i4123 = G__5;
continue;
};break;
...
let argseq__24897__auto__6 = (function () {
 let test__23322__auto__7 = (2 < args4111["length"]);
if (test__23322__auto__7 != null && test__23322__auto__7 !== false) {
return args4111.slice(2);}
})();
return f410.cljs$core$IFn$_invoke$arity$variadic((arguments[0]), (arguments[1]), argseq__24897__auto__6);
});
f410["cljs$core$IFn$_invoke$arity$variadic"] = (function (state, f, p__416) {
let vec__812 = p__416;
...
let test__23322__auto__27 = (function () {
 let or__25526__auto__28 = done24;
if (or__25526__auto__28 != null && or__25526__auto__28 !== false) {
return or__25526__auto__28;} else {
return (from14 > to15);}
})();
if (test__23322__auto__27 != null && test__23322__auto__27 !== false) {
return state.update(Object.assign(({ "changes": state.changes(changes19) }), spec16));} else {
let G__29 = iterator17.next();
let G__30 = (function () {
 let temp__24874__auto__31 = (function () {
 let and__25548__auto__32 = !lineBreak25;
if (and__25548__auto__32 != null && and__25548__auto__32 !== false) {
return f(from_pos20, value26, line_num21);} else {
return and__25548__auto__32;}
})();
if (temp__24874__auto__31 != null && temp__24874__auto__31 !== false) {
let change33 = temp__24874__auto__31;
let G__41734 = changes19;
G__41734.push(change33);
return G__41734;} else {
return changes19;}
})();
let G__35 = (from_pos20 + squint_core.count(value26));
let G__36 = (function () {
 let G__41837 = line_num21;
if (lineBreak25 != null && lineBreak25 !== false) {
return (G__41837 + 1);} else {
return G__41837;}
})();
result18 = G__29;
changes19 = G__30;
...
f410["cljs$lang$maxFixedArity"] = 2;
f410["cljs$lang$applyTo"] = (function (seq413) {
let G__41438 = squint_core.first(seq413);
let seq41339 = squint_core.next(seq413);
let G__41540 = squint_core.first(seq41339);
let seq41341 = squint_core.next(seq41339);
let self__24577__auto__42 = this;
return self__24577__auto__42.cljs$core$IFn$_invoke$arity$variadic(G__41438, G__41540, seq41341);
});
return f410;
})();
...
let doc2 = state["doc"];
return state.changeByRange((function (p__419) {
let map__34 = p__419;
let range5 = map__34;
...
let test__23322__auto__16 = (line11["number"] > squint_core.deref(at_line1));
...
let temp__24874__auto__17 = (function () {
 let and__25548__auto__18 = (to7 > line_to15);
if (and__25548__auto__18 != null && and__25548__auto__18 !== false) {
return guard(doc2.lineAt((line_to15 + 1)), (function (_PERCENT_1) {
return (_PERCENT_1["number"] > line_number14);
}));} else {
return and__25548__auto__18;}
})();
if (temp__24874__auto__17 != null && temp__24874__auto__17 !== false) {
let next_line19 = temp__24874__auto__17;
...
var iter_changed_lines = (function (p__420, f) {
let map__13 = p__420;
let tr4 = map__13;
...
let line19 = line16;
while(true){
let test__23322__auto__20 = (line_number17 > squint_core.deref(at_line11));
...
let test__23322__auto__21 = (to_b <= line_to18);
if (test__23322__auto__21 != null && test__23322__auto__21 !== false) {
return null;} else {
let next_line22 = doc7.lineAt((line_to18 + 1));
let test__23322__auto__23 = (function () {
 let and__25548__auto__24 = next_line22;
if (and__25548__auto__24 != null && and__25548__auto__24 !== false) {
return (next_line22["number"] > line19["number"]);} else {
return and__25548__auto__24;}
})();
...
let test__23322__auto__27 = squint_core.seq(next_changes12);
if (test__23322__auto__27 != null && test__23322__auto__27 !== false) {
let G__42128 = squint_core.assoc_BANG_(squint_core.select_keys(tr4, ["annotations", "scrollIntoView", "reconfigure"]), "changes", changes8.compose(next_changeset26));
let G__42129 = ((selection10 != null && selection10 !== false) ? (squint_core.assoc_BANG_(G__42128, "selection", state6["selection"].map(next_changeset26))) : (G__42128));
if (effects9 != null && effects9 !== false) {
return squint_core.assoc_BANG_(G__42129, "effects", StateEffect.mapEffects(effects9, next_changeset26));} else {
return G__42129;}} else {
return tr4;}
});
var something_selected_QMARK_ = (function (p__422) {
let map__13 = p__422;
...
var range_str = (function (state, p__423) {
let map__12 = p__423;
