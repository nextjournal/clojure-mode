...
let from3 = (function () {
 let test__23379__auto__4 = (from === to);
...
if (or__25502__auto__11 != null && or__25502__auto__11 !== false) {
return or__25502__auto__11;} else {
...
let or__25502__auto__3 = (function () {
 let temp__24910__auto__4 = f(range);
let test__23379__auto__5 = squint_core.nil_QMARK_(temp__24910__auto__4);
if (test__23379__auto__5 != null && test__23379__auto__5 !== false) {
return null;} else {
let result6 = temp__24910__auto__4;
...
let test__23379__auto__1 = changes["empty"];
if (test__23379__auto__1 != null && test__23379__auto__1 !== false) {
return null;} else {
...
let args1301 = [];
let len__24506__auto__2 = arguments["length"];
let i1313 = 0;
while(true){
let test__23379__auto__4 = (i1313 < len__24506__auto__2);
if (test__23379__auto__4 != null && test__23379__auto__4 !== false) {
...
;
let argseq__24849__auto__6 = (function () {
 let test__23379__auto__7 = (2 < args1301["length"]);
if (test__23379__auto__7 != null && test__23379__auto__7 !== false) {
return args1301.slice(2);}
})();
return f129.cljs$core$IFn$_invoke$arity$variadic((arguments[0]), (arguments[1]), argseq__24849__auto__6);
});
...
let test__23379__auto__27 = (function () {
 let or__25502__auto__28 = done24;
if (or__25502__auto__28 != null && or__25502__auto__28 !== false) {
return or__25502__auto__28;} else {
return (from14 > to15);}
})();
if (test__23379__auto__27 != null && test__23379__auto__27 !== false) {
return state.update(Object.assign(({ "changes": state.changes(changes19) }), spec16));} else {
let G__29 = iterator17.next();
let G__30 = (function () {
 let temp__24827__auto__31 = (function () {
 let and__25515__auto__32 = !lineBreak25;
if (and__25515__auto__32 != null && and__25515__auto__32 !== false) {
return f(from_pos20, value26, line_num21);} else {
return and__25515__auto__32;}
})();
if (temp__24827__auto__31 != null && temp__24827__auto__31 !== false) {
let change33 = temp__24827__auto__31;
...
let self__24515__auto__42 = this;
return self__24515__auto__42.cljs$core$IFn$_invoke$arity$variadic(G__13338, G__13440, seq13241);
});
return f129;
})();
...
let test__23379__auto__16 = (line11["number"] > squint_core.deref(at_line1));
...
let temp__24827__auto__17 = (function () {
 let and__25515__auto__18 = (to7 > line_to15);
if (and__25515__auto__18 != null && and__25515__auto__18 !== false) {
return guard(doc2.lineAt((line_to15 + 1)), (function (_PERCENT_1) {
return (_PERCENT_1["number"] > line_number14);
}));} else {
return and__25515__auto__18;}
})();
if (temp__24827__auto__17 != null && temp__24827__auto__17 !== false) {
let next_line19 = temp__24827__auto__17;
...
let line19 = line16;
while(true){
let test__23379__auto__20 = (line_number17 > squint_core.deref(at_line11));
...
let test__23379__auto__21 = (to_b <= line_to18);
if (test__23379__auto__21 != null && test__23379__auto__21 !== false) {
return null;} else {
let next_line22 = doc7.lineAt((line_to18 + 1));
let test__23379__auto__23 = (function () {
 let and__25515__auto__24 = next_line22;
...
let test__23379__auto__27 = squint_core.seq(next_changes12);
if (test__23379__auto__27 != null && test__23379__auto__27 !== false) {
