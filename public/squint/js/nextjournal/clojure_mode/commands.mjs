...
let G__325 = f(state3);
let test__243599__auto__6 = squint_core.nil_QMARK_(G__325);
...
let state3 = squint_core.get(map__12, "state");
let dispatch4 = squint_core.get(map__12, "dispatch");
let test__243599__auto__5 = n.within_program_QMARK_(state3);
if (test__243599__auto__5 != null && test__243599__auto__5 !== false) {
let G__346 = f(state3);
let test__243599__auto__7 = squint_core.nil_QMARK_(G__346);
...
let temp__31806__auto__7 = (function () {
 let G__368 = n.tree(state, from4, -1);
let G__369 = (function () {
 let test__243599__auto__10 = squint_core.nil_QMARK_(G__368);
if (test__243599__auto__10 != null && test__243599__auto__10 !== false) {
return null;} else {
return n.closest(G__368, n.coll_QMARK_);}
})();
let test__243599__auto__11 = squint_core.nil_QMARK_(G__369);
if (test__243599__auto__11 != null && test__243599__auto__11 !== false) {
return null;} else {
return u.guard(G__369, n.balanced_QMARK_);}
})();
if (temp__31806__auto__7 != null && temp__31806__auto__7 !== false) {
let nearest_balanced_coll12 = temp__31806__auto__7;
...
let or__32177__auto__9 = n.coll_QMARK_(_PERCENT_1);
if (or__32177__auto__9 != null && or__32177__auto__9 !== false) {
return or__32177__auto__9;} else {
let or__32177__auto__10 = n.string_QMARK_(_PERCENT_1);
...
let G__3815 = (function () {
 let test__243599__auto__16 = squint_core.nil_QMARK_(G__3814);
...
let test__243599__auto__17 = squint_core.nil_QMARK_(G__3815);
if (test__243599__auto__17 != null && test__243599__auto__17 !== false) {
return null;} else {
return squint_core.last(G__3815);}
})()) : (null));
let to18 = (function () {
 let test__243599__auto__19 = n.string_QMARK_(parent8);
...
let test__243599__auto__23 = squint_core.neg_QMARK_(next_newline22);
if (test__243599__auto__23 != null && test__243599__auto__23 !== false) {
return (n.end(parent8) - 1);} else {
return (from4 + next_newline22 + 1);}} else {
if (last_child_on_line13 != null && last_child_on_line13 !== false) {
let test__243599__auto__24 = n.end_edge_QMARK_(last_child_on_line13);
...
let test__243599__auto__25 = (function () {
 let G__3926 = squint_core.first(next_children12);
let G__3927 = (function () {
 let test__243599__auto__28 = squint_core.nil_QMARK_(G__3926);
if (test__243599__auto__28 != null && test__243599__auto__28 !== false) {
return null;} else {
return n.start(G__3926);}
})();
let test__243599__auto__29 = squint_core.nil_QMARK_(G__3927);
if (test__243599__auto__29 != null && test__243599__auto__29 !== false) {
return null;} else {
return (G__3927 > line_end11);}
})();
if (test__243599__auto__25 != null && test__243599__auto__25 !== false) {
...
let G__4110 = (function () {
 let test__243599__auto__11 = squint_core.nil_QMARK_(G__419);
if (test__243599__auto__11 != null && test__243599__auto__11 !== false) {
return null;} else {
return n.inner_span(G__419);}
})();
let test__243599__auto__12 = squint_core.nil_QMARK_(G__4110);
...
let or__32177__auto__3 = n.coll_QMARK_(_PERCENT_1);
if (or__32177__auto__3 != null && or__32177__auto__3 !== false) {
return or__32177__auto__3;} else {
let or__32177__auto__4 = n.string_QMARK_(_PERCENT_1);
if (or__32177__auto__4 != null && or__32177__auto__4 !== false) {
return or__32177__auto__4;} else {
return n.top_QMARK_(_PERCENT_1);}}
}));
let G__425 = (function () {
 let test__243599__auto__6 = squint_core.nil_QMARK_(G__422);
if (test__243599__auto__6 != null && test__243599__auto__6 !== false) {
return null;} else {
return n.children(G__422, from, dir);}
})();
let G__427 = (function () {
 let test__243599__auto__8 = squint_core.nil_QMARK_(G__425);
if (test__243599__auto__8 != null && test__243599__auto__8 !== false) {
return null;} else {
return squint_core.first(G__425);}
})();
let test__243599__auto__9 = squint_core.nil_QMARK_(G__427);
...
let test__243599__auto__12 = squint_core.some_QMARK_(pos1);
if (test__243599__auto__12 != null && test__243599__auto__12 !== false) {
return pos1;} else {
...
let empty6 = squint_core.get(map__12, "empty");
if (empty6 != null && empty6 !== false) {
let temp__31806__auto__7 = n.closest(n.tree(state, from4), squint_core.every_pred(n.coll_QMARK_, (function (_PERCENT_1) {
return !(function () {
 let G__508 = direction;
switch (G__508) {case 1:
let G__5110 = _PERCENT_1;
let G__5111 = (function () {
 let test__243599__auto__12 = squint_core.nil_QMARK_(G__5110);
if (test__243599__auto__12 != null && test__243599__auto__12 !== false) {
return null;} else {
return n.with_prefix(G__5110);}
})();
let G__5113 = (function () {
 let test__243599__auto__14 = squint_core.nil_QMARK_(G__5111);
if (test__243599__auto__14 != null && test__243599__auto__14 !== false) {
return null;} else {
return n.right(G__5111);}
})();
let test__243599__auto__15 = squint_core.nil_QMARK_(G__5113);
if (test__243599__auto__15 != null && test__243599__auto__15 !== false) {
return null;} else {
...
let G__5217 = (function () {
 let test__243599__auto__18 = squint_core.nil_QMARK_(G__5216);
if (test__243599__auto__18 != null && test__243599__auto__18 !== false) {
return null;} else {
return n.with_prefix(G__5216);}
})();
let G__5219 = (function () {
 let test__243599__auto__20 = squint_core.nil_QMARK_(G__5217);
if (test__243599__auto__20 != null && test__243599__auto__20 !== false) {
return null;} else {
return n.left(G__5217);}
})();
let test__243599__auto__21 = squint_core.nil_QMARK_(G__5219);
if (test__243599__auto__21 != null && test__243599__auto__21 !== false) {
return null;} else {
...
if (temp__31806__auto__7 != null && temp__31806__auto__7 !== false) {
let parent22 = temp__31806__auto__7;
let temp__31806__auto__23 = (function () {
...
if (temp__31806__auto__23 != null && temp__31806__auto__23 !== false) {
let target26 = temp__31806__auto__23;
...
let empty6 = squint_core.get(map__12, "empty");
if (empty6 != null && empty6 !== false) {
let temp__31806__auto__7 = n.closest(n.tree(state, from4), n.coll_QMARK_);
if (temp__31806__auto__7 != null && temp__31806__auto__7 !== false) {
let parent8 = temp__31806__auto__7;
let G__569 = direction;
switch (G__569) {case 1:
let temp__31806__auto__11 = (function () {
 let G__5712 = n.down_last(parent8);
let G__5713 = (function () {
 let test__243599__auto__14 = squint_core.nil_QMARK_(G__5712);
if (test__243599__auto__14 != null && test__243599__auto__14 !== false) {
return null;} else {
return n.lefts(G__5712);}
})();
let G__5715 = (function () {
 let test__243599__auto__16 = squint_core.nil_QMARK_(G__5713);
if (test__243599__auto__16 != null && test__243599__auto__16 !== false) {
return null;} else {
return squint_core.remove(n.line_comment_QMARK_, G__5713);}
})();
let G__5717 = (function () {
 let test__243599__auto__18 = squint_core.nil_QMARK_(G__5715);
if (test__243599__auto__18 != null && test__243599__auto__18 !== false) {
return null;} else {
return squint_core.drop(1, G__5715);}
})();
let test__243599__auto__19 = squint_core.nil_QMARK_(G__5717);
if (test__243599__auto__19 != null && test__243599__auto__19 !== false) {
return null;} else {
return squint_core.first(G__5717);}
})();
if (temp__31806__auto__11 != null && temp__31806__auto__11 !== false) {
let target20 = temp__31806__auto__11;
...
break;
case -1:
let temp__31806__auto__21 = (function () {
 let G__5822 = n.down(parent8);
let G__5823 = (function () {
 let test__243599__auto__24 = squint_core.nil_QMARK_(G__5822);
if (test__243599__auto__24 != null && test__243599__auto__24 !== false) {
return null;} else {
return n.rights(G__5822);}
})();
let G__5825 = (function () {
 let test__243599__auto__26 = squint_core.nil_QMARK_(G__5823);
if (test__243599__auto__26 != null && test__243599__auto__26 !== false) {
return null;} else {
return squint_core.remove(n.line_comment_QMARK_, G__5823);}
})();
let G__5827 = (function () {
 let test__243599__auto__28 = squint_core.nil_QMARK_(G__5825);
if (test__243599__auto__28 != null && test__243599__auto__28 !== false) {
return null;} else {
return squint_core.drop(1, G__5825);}
})();
let test__243599__auto__29 = squint_core.nil_QMARK_(G__5827);
if (test__243599__auto__29 != null && test__243599__auto__29 !== false) {
return null;} else {
return squint_core.first(G__5827);}
})();
if (temp__31806__auto__21 != null && temp__31806__auto__21 !== false) {
let next_first_child30 = temp__31806__auto__21;
