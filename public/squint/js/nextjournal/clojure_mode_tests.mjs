...
let vec__14 = squint_core.reduce((function (p__313, match) {
let vec__58 = p__313;
let doc9 = squint_core.nth(vec__58, 0, null);
let ranges10 = squint_core.nth(vec__58, 1, null);
let test__23322__auto__11 = (match === "|");
...
let test__23322__auto__12 = match.startsWith("<");
...
let test__23322__auto__13 = "else";
if (test__23322__auto__13 != null && test__23322__auto__13 !== false) {
...
return EditorState.create(({ "doc": doc14, "selection": (function () {
 let test__23322__auto__16 = squint_core.seq(ranges15);
...
return undefined;}
 ...
 let G__31417 = [EditorState["allowMultipleSelections"].of(true)];
if (extensions != null && extensions !== false) {
let G__31518 = G__31417;
G__31518.push(extensions);
return G__31518;} else {
return G__31417;}
})() }));
});
var state_str = (function (state) {
let doc1 = squint_core.str(state["doc"]);
return squint_core.reduce((function (doc, p__316) {
let map__23 = p__316;
