...
let vec__14 = squint_core.reduce((function (p__592, match) {
let vec__58 = p__592;
...
return undefined;}
 ...
 let G__59317 = [EditorState["allowMultipleSelections"].of(true)];
if (extensions != null && extensions !== false) {
let G__59418 = G__59317;
G__59418.push(extensions);
return G__59418;} else {
return G__59317;}
})() }));
});
var state_str = (function (state) {
let doc1 = squint_core.str(state["doc"]);
return squint_core.reduce((function (doc, p__595) {
let map__23 = p__595;
